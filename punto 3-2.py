...
Problema de puntuación de ciclopéptido: Calcule la puntuación de un péptido cíclico contra un espectro.
Entrada: Un péptido de cadena de aminoácidos y una colección de enteros Spectrum.
Salida: La puntuación de péptido contra espectro, puntuación (péptido, espectro).
'''
table = {
    'G': 57,
    'A': 71,
